...
const putSpkUrl = base_url +"/api/surat-perintah-kerja/upd";
...
function onUpdateBtnClick(){
    ...
    let spkId = document.getElementById("spkId").value.trim();
    ...
    /*else if(amountNumb < 10000001){
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                //post SPK to server
                let spkJson = genSpkJson(spkId,spkDescription, approvedQuotationDate, estimateStoreOpeningDate, companyId, sbuId, vendorId, storeId, costCenterId, assetClassId,
...
function genSpkJson(spkId,spkDescription, approvedQuotationDate, estimateStoreOpeningDate, companyId, sbuId, vendorId, storeId, costCenterId, assetClassId,
        ...
        success: function (data) {
            ...
            if(data.responseCode == 10001){
                Swal.fire({
                    ...
                    html: 'SPK number <b>' +data.suratPerintahKerja.spkId + '</b> has been Updated',
                ...
                Swal.fire({
                    title: "Unsuccessful Update Work Order",
