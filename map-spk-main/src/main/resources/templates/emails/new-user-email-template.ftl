...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border-collapse: collapse;">
    <tr>
        <td align="center" bgcolor="#FF851B" style="padding: 20px 0 20px 0;">
            <h1 style="color: #ffffff">User Activation</h1>
        </td>
    </tr>
    <tr>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color: #626262">
                <tr>
                    <td style="color: #0a0a0a; padding: 5px 0px 5px 0px;">
                        ...
                        <br/>
                        <br/>
                        <p>A new SPK account has been created for you and your username is <b>${userName}</b>.</p>
                        <p>Click below button to activate your account and input a password!</p>
                    </td>
                </tr>
                <tr>
                    <td align="center" cellspacing="0" cellpadding="0" style="padding: 15px 0px 0px 0px;">
                        <table cellspacing="10" cellpadding="10" width="100%">
                            <tr>
                                <td align="center" height="30" bgcolor="#3D9970" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
                                    <a href="${activationLink}" style="font-size:15px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:30px; width:100%; display:inline-block"><span style="color: #FFFFFF">ACTIVATE</span></a>
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td style="color: #0a0a0a; padding: 5px 0px 5px 0px;">
                        If the above Button does not work try copying and pasting ${activationLink} into your browser.
                    </td>
                </tr>
                <tr>
                    <td>
