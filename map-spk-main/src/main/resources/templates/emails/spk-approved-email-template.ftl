            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color: #626262">
                <tr>
                    <td style="color: #0a0a0a; padding: 5px 0px 5px 0px;">
                        ...
                        <br/>
                        <br/>
                        <b>${approver} (${approverEmail})</b> just approved Work Order <b>${spkDescription}</b> with details in below:
                    </td>
                </tr>
                <tr>
                    <td>
                            ...
                            <#if tipe != "a">
                              <tr>
                                <td align="center" height="30" bgcolor="#f39c12" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
                                    <#if tipe == "b">
                                        <a href="${detailLink1}" style="font-size:15px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:30px; width:100%; display:inline-block"><span style="color: #FFFFFF">DONE APPROVE SPK</span></a>
                                    <#else>
                                        <a href="${detailLink1}" style="font-size:15px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:30px; width:100%; display:inline-block"><span style="color: #FFFFFF">APPROVE SPK</span></a>
                                    </#if>
                                </td>
                              </tr>
                              <tr>
                                <td align="center" height="30" bgcolor="#f39c12" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
                                    <a href="${detailLink2}" style="font-size:15px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:30px; width:100%; display:inline-block"><span style="color: #FFFFFF">REJECT SPK</span></a>
                                </td>
                              </tr>
                              <tr>
                                <td align="center" height="30" bgcolor="#f39c12" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
                                    <a href="${detailLink}" style="font-size:15px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:30px; width:100%; display:inline-block"><span style="color: #FFFFFF">VIEW DETAIL</span></a>
                                </td>
                              </tr>
                            <#else>
                              <tr>
