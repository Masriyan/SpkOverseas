            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color: #626262">
                <tr>
                    <td style="color: #0a0a0a; padding: 5px 0px 5px 0px;">
                        ...
                        <br/>
                        <br/>
                        <b>${approver} (${approverEmail})</b> just approved Close Request for Work Order <b>${spkDescription}</b> with details in below:
                    </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" style="padding: 20px 0px 0px 0px;">
                            ...
                            <tr>
                                <td width="30%" style="color: #0a0a0a; padding: 5px 0px 5px 0px;">Close Amount</td>
                                <td align="right" style="color: #0a0a0a; padding: 5px 0px 5px 0px;">${closeAmount}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td width="30%" style="color: #0a0a0a; padding: 5px 0px 5px 0px;">Close Reason</td>
                                <td align="right" style="color: #0a0a0a; padding: 5px 0px 5px 0px;">${spkNote}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                        ...
                        <table cellspacing="10" cellpadding="10" width="100%">
                            <tr>
                                <td align="center" height="30" bgcolor="#f39c12" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
                                    <a href="${detailLink2}" style="font-size:15px; font-weight: bold; font-family: Helvetica, Arial, sans-serif; text-decoration: none; line-height:30px; width:100%; display:inline-block"><span style="color: #FFFFFF">APPROVE CLOSE</span></a>
                                </td>
                            </tr>
                            <tr>
                                <td align="center" height="30" bgcolor="#f39c12" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: #ffffff; display: block;">
