            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color: #626262">
                <tr>
                    <td style="color: #0a0a0a; padding: 5px 0px 5px 0px;">
                        ...
                        <br/>
                        <br/>
                        <b>${approver} (${approverEmail})</b> just approved Close Request for Work Order <b>${spkDescription}</b> but something went wrong during the process. Check details in below:
                    </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" style="padding: 20px 0px 0px 0px;">
                            ...
                            <tr>
                                <td width="30%" style="color: #0a0a0a; padding: 5px 0px 5px 0px;">Error</td>
                                <td align="right" style="color: #dd4b39; padding: 5px 0px 5px 0px;">${errorMessage}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
