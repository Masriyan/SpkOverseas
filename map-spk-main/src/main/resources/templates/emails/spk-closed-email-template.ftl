            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="color: #626262">
                <tr>
                    <td style="color: #0a0a0a; padding: 5px 0px 5px 0px;">
                        ...
                        <br/>
                        <br/>
                        Work Order <b>${spkDescription}</b> (${spkId}) is closed with details in below:
                    </td>
                </tr>
                <tr>
                    <td>
                        <table width="100%" style="padding: 20px 0px 0px 0px;">
                            ...
                            <tr>
                                <td width="30%" style="color: #0a0a0a; padding: 5px 0px 5px 0px;">Closed Amount</td>
                                <td align="right" style="color: #0a0a0a; padding: 5px 0px 5px 0px;">${closedAmount}</td>
                            </tr>
                            <tr>
